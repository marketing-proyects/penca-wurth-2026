...
# --- TAB 1: PRONÓSTICOS ---
with menu[0]:
    st.markdown('<div class="info-card"><b>🏆 PUNTOS:</b> 3 pts Resultado Exacto (ej: pronóstico 2-1 y terminó 2-1) | 1 pt al resultado Resultado (ej: 2-2 y terminó 1-1).<br><b>🃏 COMODÍN % PLAN JUNIO:</b> 50 pts al Resultado Exacto | 10 pts al Top 10 por aproximación.</div>', unsafe_allow_html=True)
